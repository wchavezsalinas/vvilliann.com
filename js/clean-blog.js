    ...
    $(".navMenu").on('click', function (e) {
        if (!$('#overlay').length) {
            ...
            $('#overlay').append('<h1 id="navTitle" style="opacity: 1; text-align:center; margin-top: 50px;"><b>Menu</b></h1><br>' +
                             ...
                             '<div class="row" style="opacity: 1" ><div class="col-xs-6" style="margin-left: 50px"><a href="resume.pdf"><h2 id="navContent">Resume</h2></a></div>' +
...
$( ".navMenu" ).hover(
    function() {
      ...
      $( this ).removeClass("jiggly");
    }
);

$( ".fa" ).hover(
    function() {
      $( this ).addClass("smallJiggly");
    }, function() {
      $( this ).removeClass("smallJiggly");
    }
);
